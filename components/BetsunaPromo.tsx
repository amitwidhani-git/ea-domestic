      ...
      <div className="bg-[#F42807]/15 p-3 sm:p-4">
        <div className="flex items-center justify-between gap-3">
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center justify-center border border-[#F42807] bg-[#F42807] px-4 py-2 font-display text-base tracking-wider text-[#f7f5f0] transition-colors hover:bg-[#c22006]"
          >
            Claim Offer
          </a>
        </div>

export default function SpinzwinCompactPromo() {
  return (
    <section>
      <div className="bg-[#1C1F26] p-1.5 sm:p-2">
        <div className="flex items-center justify-between gap-2">
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center justify-center border border-[#3CE619] bg-[#3CE619] px-2 py-1 font-display text-[10px] tracking-wider text-[#0A0E1E] transition-colors hover:bg-[#30bd14]"
          >
            Claim Offer
          </a>
        </div>

export default function MonsterCasinoPromo() {
  return (
    <section>
      <div className="bg-[#0070E0] p-3 sm:p-4">
        <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:justify-between sm:text-left">
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center justify-center border border-[#F0D000] bg-[#F0D000] px-4 py-2 font-display text-base tracking-wider text-[#0A0E1E] transition-colors hover:bg-[#c9ac00]"
          >
            Claim Offer
          </a>
        </div>

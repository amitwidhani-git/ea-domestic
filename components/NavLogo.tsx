...
export default function NavLogo() {
  return (
    <Link href="/" className="group flex shrink-0 -translate-y-[2px] items-center gap-2.5 no-underline">
      <svg width="20" height="18" viewBox="1 -1 62 58" fill="none" aria-hidden="true" className="opacity-80">

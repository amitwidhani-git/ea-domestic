export default function MogobetCompactPromo() {
  return (
    <section>
      <div className="bg-[#FF0B00]/15 p-1.5 sm:p-2">
        <div className="flex items-center justify-between gap-2">
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center justify-center border border-[#FF0B00] bg-[#FF0B00] px-2 py-1 font-display text-[10px] tracking-wider text-[#f7f5f0] transition-colors hover:bg-[#cc0900]"
          >
            Claim Offer
          </a>
        </div>
